...
class MenuScene(BaseScene):
    def create_objects(self) -> None:
        self.button_start = ButtonObject(
            self.game,
            self.game.WIDTH // 2 - 125, self.game.HEIGHT // 2 - 25 - 50 - 50, 200, 50,
        ...
        self.button_exit = ButtonObject(
            self.game,
            self.game.WIDTH // 2 - 125, self.game.HEIGHT // 2 + 25 + 50, 200, 50,
    ...
    def additional_draw(self) -> None:
        self.background = Background('images/kf7Zl44.jpg', [0,0])
        self.logo = Logo('images/pngfind.com-pac-man-logo-png-6885860.png', [225,35])
